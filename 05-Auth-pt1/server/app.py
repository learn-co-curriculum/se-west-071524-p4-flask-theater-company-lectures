...
app.secret_key = b"&\n\xa3#\x1f\xee\x05g\xad}\xb0\x1b\xe5\xe9\xee\xbe"
...
class Users(Resource):
    def post(self):
        ...
        try:
            ...
            abort(422, "Some inputs failed validation")
        db.session.add(new_user)
        db.session.commit()
        session["user_id"] = new_user.id  # gives new_user "logged_in" status
...
# TODO: Unauthorized error handler
